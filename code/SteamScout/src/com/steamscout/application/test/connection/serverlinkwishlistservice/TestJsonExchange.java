...
public class TestJsonExchange {
	...
	public void testDoesNotAllowNullUsername() {
		TestServerLinkWishlistService service = new TestServerLinkWishlistService("5465465");
		assertThrows(IllegalArgumentException.class, () -> service.setUsername(null));
	}
	
	@Test
	public void testDoesNotAllowNullAccountId() {
		assertThrows(IllegalArgumentException.class, () -> new TestServerLinkWishlistService(null));
	}
	
	@Test
	public void testBuildsCorrectSendingJson() {
		TestServerLinkWishlistService service = new TestServerLinkWishlistService("655449849");
